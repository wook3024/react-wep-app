...
# Description
* 이 앱은 소셜네트워크서비스 기능 제공을 위해 제작되었다. 
* 프론트엔드 부분은 React와 Redux를 이용했고, 백엔드 부분은 Express를 사용했다.
* 트래픽의 총량을 줄이기 위해 싱글 페이지 애플리케이션으로 구현했다.
* 기본적으로 포스팅 작성, 대댓글, 팔로우, 좋아요, 알림과 같은 기능을 포함한다. 
